# Я хочу писать более сложный HTML

## Я хочу писать более сложный HTML

В текущем состоянии я могу выражать только имена и атрибуты тегов, а также содержимое текста.\
Поэтому я хочу иметь возможность писать более сложный HTML в шаблоне.\
В частности, я хочу иметь возможность компилировать такой шаблон:
