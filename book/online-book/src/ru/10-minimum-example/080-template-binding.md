...
## Хочу привязывать данные к шаблону

В настоящее время мы напрямую манипулируем DOM, поэтому мы не можем использовать преимущества системы реактивности или Virtual DOM.  
На самом деле мы хотим писать обработчики событий и текстовое содержимое в секции шаблона. В этом и заключается радость декларативного UI.  
Мы стремимся к такому интерфейсу разработчика:
